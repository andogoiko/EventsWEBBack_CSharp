...
namespace WebApi.Middleware
{
    public class JwtMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, projectContext userService)
        {
            // ====> Request ===>
        ...
        private void attachUserToContext(HttpContext context, projectContext userService, string token)
        {
            try
            {
